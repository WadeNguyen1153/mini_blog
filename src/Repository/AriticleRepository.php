...
/**
 * @extends ServiceEntityRepository<Ariticle>
 *
...
class AriticleRepository extends ServiceEntityRepository
{
    ...
    public function add(Ariticle $entity, bool $flush = false): void
    {
    ...
    public function remove(Ariticle $entity, bool $flush = false): void
    {
